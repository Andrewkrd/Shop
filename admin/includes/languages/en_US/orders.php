...
table_heading_customers_id = Customer ID
...
email_subject_html = Order Update (%s)
email_body_html = %s<br>
------------------------------------------------------<br>
Order Number: %s<br>
Detailed Invoice: %s<br>
Date Ordered: %s<br>
email_body_comment_html = Order Comment<br>
------------------------------------------------------<br>
%s
email_body_status_html = Order Status<br>
------------------------------------------------------<br>
New Status: %s
email_body_contact_html = Please reply to this e-mail if you have any questions regarding this order.
