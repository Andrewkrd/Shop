...
store_version = Current Version: 1.01 rev.429

administration_title = RuBi— Administration Tool
...
access_configuration_title39 = Heading Image Width
access_configuration_title40 = Heading Image Height
...
access_configuration_title89 = Enable download
access_configuration_title90 = Download by redirect
access_configuration_title91 = Expiry delay (days)
access_configuration_title92 = Maximum number of downloads
access_configuration_title93 = Confirm Terms and Conditions During Checkout Procedure
access_configuration_title94 = Confirm Privacy Notice During Account Creation Procedure
access_configuration_title95 = Verify With Regular Expressions
access_configuration_title96 = Verify With Javascript
...
access_configuration_title123 = The pixel width of heading images
access_configuration_title124 = The pixel height of heading images
...
access_configuration_title173 = Enable the products download functions.
access_configuration_title174 = Use browser redirection for download. Disable on non-Unix systems.
access_configuration_title175 = Set number of days before the download link expires. 0 means no limit.
access_configuration_title176 = Set the maximum number of downloads. 0 means no download authorized.
access_configuration_title177 = Show the Terms and Conditions during the checkout procedure which the customer must agree to.
access_configuration_title178 = Show the Privacy Notice during the account creation procedure which the customer must agree to.
access_configuration_title179 = Verify credit card numbers with server-side regular expression patterns.
access_configuration_title180 = Verify credit card numbers with javascript based regular expression patterns.
