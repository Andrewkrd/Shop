...
*/
  ...
  class osC_Template_love_design {
    var $_id,
        $_title = 'Richer Designs Resize Template',
        $_code = 'love_design',
        $_author_name = 'Richer Designs and RuBiC (modding)',
        $_author_www = 'http://www.richerdesigns.com and http://www.rubicshop.ru',
    ...
    function install() {
      ...
      $data = array('categories' => array('*', 'left', '100'),
                    ...
                    'templates' => array('*', 'left', 600),
                    'slide_show' => array('index/index', 'slideshow', 100),
                    'checkout_trail' => array('checkout/*', 'left', 700),
                    'cms_sitemap' => array('info/info_sitemap', 'after', 200),
                    'cms_xsell' => array('products/*', 'after', 200),
                    'cms_xsell_products' => array('cms/view', 'after', 200),
                    'checkout_trail' => array('checkout/*', 'before', 100),
                    'cms' => array('*', 'right', 1100));
