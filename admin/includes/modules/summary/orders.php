...
/* Private methods */
    ...
    function _setData() {
      ...
      $this->_data = '<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">' .
                     ...
                     '      <th align="right">' . $osC_Language->get('summary_orders_table_heading_status') . '</th>' .
                     '    </tr>' .
                     '  </thead>' .
                     '  <tbody>';
      ...
      while ( $Qorders->next() ) {
        $this->_data .= '    <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">' .
                        ...
                        '      <td align="center">' . $Qorders->value('date_last_modified') . '</td>' .
                        '      <td align="right">' . $Qorders->value('orders_status_name') . '</td>' .
                        '    </tr>';
      }
