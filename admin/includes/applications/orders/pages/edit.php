...
?>
        ...
        <tr>
          <td align="left" valign="top" align="right"><?php echo $products['quantity'] . '&nbsp;x'; ?></td>
          <td valign="top">
...
?>
          ...
          <td align="right" valign="top"><?php echo $products['model']; ?></td>
...
?>
  ...
  <div id="section_transaction_history_content">
    <table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
      <thead>
        <tr>
          <th align="left" width="130"><?php echo $osC_Language->get('table_heading_date_added'); ?></th>
...
?>
  ...
  <div id="section_status_history_content">
    <table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
      <thead>
        <tr>
          <th align="left"><?php echo $osC_Language->get('table_heading_date_added'); ?></th>
          <th align="left"><?php echo $osC_Language->get('table_heading_status'); ?></th>
          <th><?php echo $osC_Language->get('table_heading_comments'); ?></th>
