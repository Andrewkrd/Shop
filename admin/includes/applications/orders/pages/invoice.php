...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
      <thead>
        <tr>
          <th align="left" colspan="2"><?php echo $osC_Language->get('table_heading_products'); ?></th>
          <th align="right"><?php echo $osC_Language->get('table_heading_product_model'); ?></th>
          <th align="right"><?php echo $osC_Language->get('table_heading_tax'); ?></th>
          <th align="right"><?php echo $osC_Language->get('table_heading_price_net'); ?></th>
          <th align="right"><?php echo $osC_Language->get('table_heading_price_gross'); ?></th>
          <th align="right"><?php echo $osC_Language->get('table_heading_total_net'); ?></th>
          <th align="right"><?php echo $osC_Language->get('table_heading_total_gross'); ?></th>
        </tr>
      </thead>
      <tbody>
<?php
    foreach ($osC_Order->getProducts() as $product) {
      echo '        <tr>' . "\n" .
           '          <td align="left" valign="top" align="right">' . $product['quantity'] . '&nbsp;x</td>' . "\n" .
           '          <td align="left" valign="top">' . $product['name'];
      ...
      echo '          </td>' . "\n" .
           '          <td align="right" valign="top">' . $product['model'] . '</td>' . "\n";
      echo '          <td align="right" valign="top">' . $osC_Tax->displayTaxRateValue($product['tax']) . '</td>' . "\n" .
           '          <td align="right" valign="top"><b>' . $osC_Currencies->format($product['price'], $osC_Order->getCurrency(), $osC_Order->getCurrencyValue()) . '</b></td>' . "\n" .
           ...
           '          <td align="right" valign="top"><b>' . $osC_Currencies->format($product['price'] * $product['quantity'], $osC_Order->getCurrency(), $osC_Order->getCurrencyValue()) . '</b></td>' . "\n" .
