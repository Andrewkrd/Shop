...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
  <thead>
    <tr>
      <th align="left"><?php echo $osC_Language->get('table_heading_attribute_groups'); ?></th>
      <th align="center"><?php echo $osC_Language->get('table_heading_sort_order'); ?></th>
      <th align="center"><?php echo $osC_Language->get('table_heading_total_entries'); ?></th>
...
?>
    ...
    <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">
      ...
      <td align="center"><?php echo $Qgroups->valueInt('sort_order'); ?></td>
      <td align="center"><?php echo $Qentries->valueInt('total'); ?></td>
      <td align="right">
