...
<div class="moduleBox">
  ...
  <div class="content">
    <?php echo osc_image('templates/' . $osC_Template->getCode() . '/images/account_personal.gif', $osC_Language->get('my_account_title'), null, null, 'style="float: left;"'); ?>
...
<div class="moduleBox">
  ...
  <div class="content">
    <?php echo osc_image('templates/' . $osC_Template->getCode() . '/images/account_orders.gif', $osC_Language->get('my_orders_title'), null, null, 'style="float: left;"'); ?>
...
<div class="moduleBox">
  ...
  <div class="content">
    <?php echo osc_image('templates/' . $osC_Template->getCode() . '/images/account_notifications.gif', $osC_Language->get('my_notifications_title'), null, null, 'style="float: left;"'); ?>
