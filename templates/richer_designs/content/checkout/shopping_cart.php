...
?>
      ...
      <tr>
        <td class="submitFormButtons" valign="top" width="60"><?php echo $osC_Template->osc_draw_image_jquery_button(array('href' => osc_href_link(FILENAME_CHECKOUT, 'action=cart_remove&item=' . $products['item_id'], 'SSL'), 'icon' => 'trash', 'title' => $osC_Language->get('button_delete'))); ?></td>
        <td valign="top">
...
<div class="submitFormButtons">
  ...
  <?php echo $osC_Template->osc_draw_image_jquery_button(array('icon' => 'refresh', 'title' => $osC_Language->get('button_update_cart'))); ?>
</div>
