...
<div class="moduleBox" style="width: 49%; float: right;">
  ...
  <div class="content">
    ...
    <p align="right"><?php echo $osC_Template->osc_draw_image_jquery_button(array('icon' => 'key', 'title' => $osC_Language->get('button_sign_in'))); ?></p>
  </div>
...
<div class="moduleBox" style="width: 49%;">
  ...
  <div class="content">
    ...
    <p align="right"><?php echo $osC_Template->osc_draw_image_jquery_button(array('href' => osc_href_link(FILENAME_ACCOUNT, 'create', 'SSL'), 'icon' => 'triangle-1-e', 'title' => $osC_Language->get('button_continue'))); ?></p>
  </div>
</div>
