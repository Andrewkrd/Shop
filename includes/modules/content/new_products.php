      ...
      global $osC_Database, $osC_Services, $osC_Language, $osC_Currencies, $osC_Image, $osC_Specials, $current_category_id, $osC_Template;
        ...
        while ($Qproducts->next()) {
          ...
          $this->_content .= '<div style="float:left; width: 33%; text-align: center">' .
                             ...
                             '<span id="FormButtons">' . osc_link_object(osc_href_link(basename($_SERVER['SCRIPT_FILENAME']), $Qproducts->value('products_keyword') . '&action=cart_add'), $osC_Template->osc_draw_image_jquery_button(array('icon' => 'cart', 'title' => $osC_Language->get('button_buy_now')))) . '</span><br/><br/></div>';
          }
          $i++;
        }
